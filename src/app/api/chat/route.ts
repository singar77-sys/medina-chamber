...
- Board President: Steve Allison (Fire-Dex)
...
- All tiers include: directory listing, member portal access, networking events, job postings, magazine subscription, post sharing on Chamber socials, advertising & sponsorship opportunities, advocacy, Safety Council enrollment free (meetings $24/person), 5 savings programs, ribbon cuttings, free notary
...
- Safety Council (medinachamber.com/programs/safety-council), Ohio BWC rebate program; enrollment free for chamber members ($100/year for non-members), meetings $24 per person; monthly meetings 3rd Tuesday 11:30–1 at Williams on the Lake; FY27 enrollment deadline is September 30, 2026 (contact safety@medinaohchamber.com about current enrollment); the BWC rebate needs 10 Safety Council CREDITS in the fiscal year, earned by monthly meeting attendance (1/month), approved external training (max 2), or a BWC on-site consultation (2) — not 10 meetings specifically
