  ...
  return (
    <article className="mx-auto max-w-3xl px-6 lg:px-8 py-f55 lg:py-f89">
      <header className="mb-f34">
        <p className="text-overline text-cambridge mb-f13">About</p>
      ...
      <section className="prose prose-lg max-w-none text-text-primary">
        <h2 className="text-h2 mt-f34 mb-f13">The short version</h2>
        ...
        <h2 className="text-h2 mt-f34 mb-f13">What we collect and why</h2>

        <h3 className="text-h3 mt-f21 mb-f8">ChamberBot conversations</h3>
        ...
        <ul className="space-y-2 text-body text-text-secondary mt-f8">
        ...
        <h3 className="text-h3 mt-f21 mb-f8">Contact and membership forms</h3>
        <p className="text-body text-text-secondary">
        ...
        <h3 className="text-h3 mt-f21 mb-f8">Site analytics</h3>
        <p className="text-body text-text-secondary">
        ...
        <h3 className="text-h3 mt-f21 mb-f8">Member directory data</h3>
        <p className="text-body text-text-secondary">
        ...
        <h2 className="text-h2 mt-f34 mb-f13">Security</h2>
        <p className="text-body text-text-secondary">
        ...
        <h2 className="text-h2 mt-f34 mb-f13">Cookies</h2>
        <p className="text-body text-text-secondary">
        ...
        <h2 className="text-h2 mt-f34 mb-f13">Your options</h2>
        <p className="text-body text-text-secondary">
        ...
        <h2 className="text-h2 mt-f34 mb-f13">Changes to this page</h2>
        <p className="text-body text-text-secondary">
        ...
        <h2 className="text-h2 mt-f34 mb-f13">Questions</h2>
        <p className="text-body text-text-secondary">
      ...
      <footer className="mt-f55 pt-f34 border-t border-border-secondary">
        <Link
          href="/"
