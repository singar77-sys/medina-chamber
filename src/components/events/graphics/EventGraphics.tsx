...
/* =============================================================================
   2 — SAFETY COUNCIL  (v3 — official designed artwork, replaces the drawn
   Metatron's-Cube composition)

   Same clean OfficialArtworkGraphic structure as Networking WOW (section 1)
   — artwork only, no text overlay.
   ============================================================================ */

export function SafetyCouncilGraphic(_props: {
  mode?: GraphicMode;
  eventInfo?: EventInfo;
}) {
  return <OfficialArtworkGraphic src={ASSETS.safetyCouncilArt} />;
}
